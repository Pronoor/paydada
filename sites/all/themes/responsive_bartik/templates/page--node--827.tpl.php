...
if (isset($_POST['pronoor_pay_submit'])) {
    ...
    $merchantAuthentication->setName('8uW3w27Sh');
    $merchantAuthentication->setTransactionKey('8hm99Q8Fe7j67SeV');
    ...
    $customerAddress->setFirstName($_POST['card_holder']);
    $customerAddress->setAddress($_POST['billing_address']);
    $customerAddress->setCity($_POST['city']);
    $customerAddress->setState("state");
    $customerAddress->setZip($_POST['zip_code']);
    $customerAddress->setCountry($_POST['country_code']);
    ...
    $transactionRequestType->setAmount(str_replace('$', "", $_POST['amount']));
    ...
    if ($response != null) {
        ...
        if ($response->getMessages()->getResultCode() == "Ok") {
            ...
            if ($tresponse != null && $tresponse->getMessages() != null) {
                $auth_success = 1;
                $success_message = " Successfully created transaction with Transaction ID: " . $tresponse->getTransId() . "\n";
                $tran_no = $tresponse->getTransId();
                ...
                if ($tresponse->getErrors() != null) {
                    $error_message .= " Error Code  : " . $tresponse->getErrors()[0]->getErrorCode() . "\n";
...
<link href="https://www.paydada.com/mail/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" href="<?php print $base_path; ?>Document_files/style.css">
<!-- MetisMenu CSS -->
<link href="https://www.paydada.com/mail/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

<!-- Timeline CSS -->
<link href="https://www.paydada.com/mail/dist/css/timeline.css" rel="stylesheet">

<!-- Custom CSS -->
<link href="https://www.paydada.com/mail/dist/css/sb-admin-2.css" rel="stylesheet">

<!-- Morris Charts CSS -->
<link href="https://www.paydada.com/mail/bower_components/morrisjs/morris.css" rel="stylesheet">

<!-- Custom Fonts -->
<link href="https://www.paydada.com/mail/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
...
<!-- DataTables CSS -->
<link href="https://www.paydada.com/mail/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css"
      rel="stylesheet">

<!-- DataTables Responsive CSS -->
<link href="https://www.paydada.com/mail/bower_components/datatables-responsive/css/dataTables.responsive.css"
      rel="stylesheet">
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;height: 148px;">
        <div class="navbar-header" style="width: 40%">
            ...
            <a class="navbar-brand" href="https://www.paydada.com/mail/admin/index">
                <!--<?= isset($_GET['logotitle']) ? $_GET['logotitle'] : '' ?> partners with ProNoor for secure Financial Transactions--></a>

        </div>
        <!-- /.navbar-header -->


        <a href="https://paydada.com">
        ...
        <ul class="nav navbar-top-links navbar-right" style='margin-top: -98px;'>
            <a class="btn btn-primary" href="https://www.pronoor.com" style="width:auto;height:auto">Home</a>&nbsp;&nbsp;
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="https://www.paydada.com/shopping_cart/user/login"><i class="fa fa-sign-out fa-fw"></i>
                            Login</a>
                    <li><a href="https://www.paydada.com/shopping_cart/user/register"><i
...
<!--                    <li><a href="https://www.paydada.com/shopping_cart/financial/transaction"><i-->
<!--                                    class="fa fa-dashboard fa-fw"></i> Financial Transactions</a></li>-->
<!--                    <li><a href="https://www.paydada.com/shopping_cart/financial/activity"><i-->
<!--                                    class="fa fa-dashboard fa-fw"></i> Financial Activity</a></li>-->
                </ul>
                <!-- /.dropdown-user -->
        ...
        <br>
        <span class='pull-right mobile_image' style=''><p><strong>US$</strong></p>
            <img width='248px' src='https://www.pronoor.com/images/imgpsh_fullsize.jpg'></span>
                    ...
                    <div id="">
                        <div id="page">
                            <div class="checkout-panel">
                                <form action='https://www.paydada.com/shopping_cart/submit' method='post'>
                                        ...
                                        <div class="row">
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group"
                                                     <?php if (isset($_POST['cart_price'])): ?>style='padding-top:11px'<?php endif; ?>>
                                                    ...
                                                    <?php if (isset($_POST['cart_price'])): ?>
                                                        <input type="hidden" name="nasty_thing" id="nasty_thing"
                                                               value='<?php echo responsive_bartik_get_enscrypt($_POST['cart_price']); ?>'
                                                               class="form-control"/><span style=''><input type='text'
                                                                                                           name="amount"
                                                                                                           style='width:40%;background-color:gainsboro'
                                                                                                           value="$<?php echo $_POST['cart_price']; ?>"
                                                                                                           readonly/></strong></span>
                                                    <?php else: ?>
                                                        <input type="text" name="amount" id="amount"
                                                               placeholder="Enter amount" required class="form-control"
                                                               value="<?php if (isset($_SESSION['credit_form_data']['amount'])):echo $_SESSION['credit_form_data']['amount'];endif; ?>"/>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" id="email"
                                                           ...
                                                           value="<?php if (isset($_SESSION['credit_form_data']['email'])):echo $_SESSION['credit_form_data']['email'];endif; ?>"/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required id="cardholder" name='card_holder'
                                                           placeholder='Cardholder name' class="warning"
                                                           value="<?php if (isset($credit_data[0]->card_holder)):echo $credit_data[0]->card_holder; elseif (isset($credit_holder_name[0]->person_name)):echo $credit_holder_name[0]->person_name; elseif (isset($_SESSION['credit_form_data']['card_holder'])):echo $_SESSION['credit_form_data']['card_holder'];endif; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php $credit_condition = 0;
                                                    if (!empty($credit_data)):$credit_condition = 1;
                                                        ?>
                                                        <select name='card_number_select' class="warning"
                                                                style="width:88%" id='card_number_select'>
                                                            ...
                                                            <?php endforeach; ?>
                                                        </select><a href="void:javascript();"
                                                                    class="btn next-btn anchor_add_credit"
                                                                    id="add_credit" style="
    float: right;
    display: inline;
    width: 9%;
...
">+</a>
                                                    <?php else: ?>
                                                        <a href="void:javascript();"
                                                           class="btn next-btn anchor_add_credit" id="add_credit"
                                                           style="
    float: right;
    display: inline;
    width: 9%;
...
">+</a>
                                                        <input type="text" name='card_number' placeholder='Card number'
                                                               id="cardnumber" class="warning"> <p class="log"></p>
                                                    <?php endif; ?>
                                        ...
                                        <div class="row">
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="month" class="warning"
                                                            style='width:40%;float:left;padding-right:3px'>
                                                        <option value='01' <?php if ('01' == $month):echo "selected='selected'";endif; ?>>
                                                            1
                                                        </option>
                                                        <option value='02' <?php if ('02' == $month):echo "selected='selected'";endif; ?>>
                                                            2
                                                        </option>
                                                        <option value='03' <?php if ('03' == $month):echo "selected='selected'";endif; ?>>
                                                            3
                                                        </option>
                                                        <option value='04' <?php if ('04' == $month):echo "selected='selected'";endif; ?>>
                                                            4
                                                        </option>
                                                        <option value='05' <?php if ('05' == $month):echo "selected='selected'";endif; ?>>
                                                            5
                                                        </option>
                                                        <option value='06' <?php if ('06' == $month):echo "selected='selected'";endif; ?>>
                                                            6
                                                        </option>
                                                        <option value='07' <?php if ('07' == $month):echo "selected='selected'";endif; ?>>
                                                            7
                                                        </option>
                                                        <option value='08' <?php if ('08' == $month):echo "selected='selected'";endif; ?>>
                                                            8
                                                        </option>
                                                        <option value='09' <?php if ('09' == $month):echo "selected='selected'";endif; ?>>
                                                            9
                                                        </option>
                                                        <option value='10' <?php if ('10' == $month):echo "selected='selected'";endif; ?>>
                                                            10
                                                        </option>
                                                        <option value='11' <?php if ('11' == $month):echo "selected='selected'";endif; ?>>
                                                            11
                                                        </option>
                                                        <option value='12' <?php if ('12' == $month):echo "selected='selected'";endif; ?>>
                                                            12
                                                        </option>
                                                    </select>
                                                    <?php if (isset($credit_data[0]->exp_month)):
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required placeholder='CVV' style="width:96%"
                                                           name='cvv' id="verification" class="warning">
                                                </div>
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <input type="text" required placeholder='Billing address'
                                                           id="billing_address" name='billing_address' class="warning"
                                                           value="<?php if (isset($credit_data[0]->address)):echo $credit_data[0]->address; elseif (isset($_SESSION['credit_form_data']['billing_address'])):echo $_SESSION['credit_form_data']['billing_address'];endif; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="country" name='country'
                                                            class="green_light_border country" required="">
                                                    ...
                                                    <select class="form-control country_code" id="country_code"
                                                            required="required" name="country_code"
                                                            style='display:none'>
                                                        ...
                                                        <option value="Congo, the Democratic Republic of the">243
                                                        </option>
                                                        ...
                                                        <option value="French Southern Territories">33</option>
                                                        ...
                                                        <option value="Heard Island and McDonald Islands">61</option>
                                                        <option value="Holy See (Vatican City State)">39</option>
                                                        ...
                                                        <option value="Pitcairn">649</option>
                                                        ...
                                                        <option value="Sint Maarten (Dutch part)">721</option>
                                                        ...
                                                        <option value="USA" selected="selected">1</option>
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6"
                                                 style="padding:0">
                                                <div class="form-group">
                                                    <input type="tel" size="3" id="code" value='1' name="phone" readonly
                                                           style='width:22%;background-color:gainsboro'>-(<input
                                                            type="tel" size="3" name='phone1' id='phone1'
                                                            style='width:60%' required
                                                            value="<?php if (isset($_SESSION['credit_form_data']['phone1'])):echo $_SESSION['credit_form_data']['phone1'];endif; ?>">)
                                        ...
                                        <div class="row">
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required id="city" name="city" placeholder="City"
                                                           class="warning"
                                                           value="<?php if (isset($credit_data[0]->city)):echo $credit_data[0]->city; elseif (isset($_SESSION['credit_form_data']['city'])):echo $_SESSION['credit_form_data']['city'];endif; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required id="state" style='width:50%'
                                                           name="state" placeholder="State" class="warning"
                                                           value="<?php if (isset($credit_data[0]->state)):echo $credit_data[0]->state; elseif (isset($_SESSION['credit_form_data']['state'])):echo $_SESSION['credit_form_data']['state'];endif; ?>">

                                                    <input type="text" required id="zip_code" style='width:48%'
                                                           name="zip_code" placeholder="Zip code" class="warning"
                                                           value="<?php if (isset($credit_data[0]->zipcode)):echo $credit_data[0]->zipcode; elseif (isset($_SESSION['credit_form_data']['zip_code'])):echo $_SESSION['credit_form_data']['zip_code'];endif; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-footer" style="background:none">
                                            <button class="btn next-btn" type="submit" value='1' id='pronoor_pay_submit'
                                                    name='pronoor_pay_submit'>Submit
                                            </button>
    ...
    padding-left: 20px;'>RETURN AND REFUND POLICY</a>
            ...
            <script src="https://www.paydada.com/mail/js/jquery.min.js"></script>
        ...
        <nav class="navbar" style="border-radius:0px">
            <div class="container center">
                <ul class="nav footer_menu">
                    ...
                    <li class="navbar-text"><a href="https://www.paydada.com/index.php?page=6&amp;type=2">Contact Us</a>
                    </li>
                    <li class="navbar-text"><a href="https://www.paydada.com/index.php?page=6&amp;type=22">Terms &amp;
                            Conditions</a></li>
                    <li class="navbar-text"><a href="https://www.paydada.com/index.php?page=6&amp;type=23">Privacy
                            Policy</a></li>

                    <li class="navbar-text"><a href="https://www.paydada.com/index.php?page=6&amp;type=32">About PWS</a>
                    </li>
            ...
            <div class="center footer_down">
                <p style="color:white">© 2017-20 Paydada Shopping Cart, All Rights Reserved. Powered by ProNoor </p>
            </div>
        </nav>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mar">
                    ...
                    <p>Any porduct or service purchased through <a href="http://www.paydada.com">www.paydada.com</a>
                        shopping cart is returnable or can be cancelled at any time during the service period. The
                        refund is provided to the credit card charged at the time of transaction. Following are the
                        rules for refund:<br><br>A: Total refund if caneclled and claimed within 30 days of the
                        transaction, for any reason<br>B: Service or services cancelled after the first month will be
                        refunded based on the prorated use including the first month provided that the refund is
                        requested five buisness days before the billing cycle. <br>C: There is no refund for any
                        software, shipped to you after the package is opened or the seal is broken of any such
                        product.<br>D: Currently there is no product that has a shipping fee; However, if there is a
                        shipping fee involved in future it will not be refunded.<br>E: Any service can be upgraded or
                        down graded at any time without penalty. However, the change in cost will be effective from next
                        billing cycle.<br>F: Any product can be excahnged within ninty days from the date of
                        transaction.<br>G:Technical services and support not related to the items sold will be charged
                        seperately according to the pre disclosed rate. Such a service is not available at this time.
                    </p>
                    <p>&nbsp;</p>
...
<script src="https://www.paydada.com/mail/js/jquery.validate.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="https://www.paydada.com/mail/bower_components/bootstrap/dist/js/bootstrap.js"></script>

<!-- Metis Menu Plugin JavaScript -->
<script src="https://www.paydada.com/mail/bower_components/metisMenu/dist/metisMenu.min.js"></script>

<script src="//cdn.datatables.net/1.10.5/js/jquery.dataTables.min.js"></script>
<script src="https://www.paydada.com/mail/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
...
<!--<script src="https://www.paydada.com/mail/bower_components/raphael/raphael-min.js"></script>
<script src="https://www.paydada.com/mail/bower_components/morrisjs/morris.min.js"></script>
<script src="https://www.paydada.com/mail/js/morris-data.js"></script>-->

<!-- Custom Theme JavaScript -->
<script src="https://www.paydada.com/mail/dist/js/sb-admin-2.js"></script>
