...
if(isset($_POST['pronoor_pay_submit']))
{
	...
	extract($_POST);
	list($firstname, $lastname) = explode(' ', $card_holder);
	$url = 'https://api.convergepay.com/VirtualMerchant/process.do'; 
	$fields = array(
	'ssl_merchant_id'=>'819857',
	'ssl_user_id'=>'propage',
	'ssl_pin'=>'YKWC0828GOQAD3UVHKSTUDLJKALMQ562IJSAGXMKOE4H74DWNDOVNV3IUHYRD8AY',
	'ssl_transaction_type'=>'ccsale',
	'ssl_first_name'=>$firstname,
	'ssl_last_name'=>$lastname,
	'ssl_show_form'=>'false',
	'ssl_receipt_decl_get_url'=>'https://www.pronoor.com/shopping_cart/submit?error=1',
	'ssl_error_url'=>'https://www.pronoor.com/shopping_cart/submit?error=1',
	'ssl_receipt_apprvl_get_url'=>'https://www.pronoor.com/shopping_cart/submit?succes=1',
	'ssl_amount'=>$amount,
	'ssl_card_present'=>'Y',
...
?>
<link href="https://www.pronoor.com/mail/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" href="<?php print $base_path ; ?>Document_files/style.css">
    <!-- MetisMenu CSS -->
    <link href="https://www.pronoor.com/mail/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="https://www.pronoor.com/mail/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="https://www.pronoor.com/mail/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="https://www.pronoor.com/mail/bower_components/morrisjs/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="https://www.pronoor.com/mail/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <!-- DataTables CSS -->
    <link href="https://www.pronoor.com/mail/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="https://www.pronoor.com/mail/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header" style="width: 40%">
               ...
               <a class="navbar-brand" href="https://www.pronoor.com/mail/admin/index"><!--<?=isset($_GET['logotitle'])?$_GET['logotitle']:''?> partners with ProNoor for secure Financial Transactions--></a>
            </div>
            <!-- /.navbar-header -->
			
		
<a href="https://www.pronoor.com/mail/admin/index">
<img src="https://www.pronoor.com/mail/images/logo.jpg" width="167px" style='padding-bottom: 11px;'>
			...
			<a class="btn btn-primary" href="https://pronoor.com" style="width:auto;height:auto">Home</a>&nbsp;&nbsp;
                ...
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
						...
						<li><a href="https://www.pronoor.com/mail/?url=admin/login"><i class="fa fa-sign-out fa-fw"></i> Login</a>
						<li><a href="https://www.pronoor.com/mail/?url=admin/register"><i class="fa fa-sign-out fa-fw"></i> Register</a>
						<li><a href="#"><i class="fa fa-dashboard fa-fw"></i> Financial Accounts</a></li>
						<li><a href="#"><i class="fa fa-dashboard fa-fw"></i> Deposit</a></li>
						<li><a href="#"><i class="fa fa-dashboard fa-fw"></i> Withdrawl</a></li>
		...
		<div id="page-wrapper" style='min-height: 1507px;margin:0 0 0 0'>
            ...
            <div class="row">
    			<?php if(isset($_GET['error'])) {?>
                    <div class="alert alert-danger"><?php echo $_GET['errorName']?></div>
                <?php } elseif(isset($_GET['error'])) {?>
                    <div class="alert alert-success">Payment made successfully </div>
                <?php } ?>
    			<center>
    			    <h1 style=''>PRONOOR PAY</H1>
                </center>
	...
	<div class="row">
						<div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6" >
							<div class="form-group" <?php if(isset($_POST['cart_price'])):?>style='padding-top:11px'<?php endif;?>>
								...
								<?php if(isset($_POST['cart_price'])):?>
								    <input type="hidden" name="amount" value="<?php echo $_POST['cart_price']?>" />
									<input type="hidden" name="nasty_thing" id="nasty_thing" value='<?php echo responsive_bartik_get_enscrypt($_POST['cart_price']);?>' class="form-control" /><span style=''>Transaction Amount :<strong>$<?php echo $_POST['cart_price'];?></strong></span>
								<?php else:?>
									<input type="text" name="amount" id="amount" placeholder="Enter amount" required class="form-control" />
								<?php endif;?>
							</div>
						</div>
						...
						<div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6" >
							<div class="form-group">
								...
								<!--<input type="text" placeholder="msg" name="msg" id="email" class="form-control"  value="" />-->
								<input type="email" name="email" id="email" placeholder="Enter email" required class="form-control" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''?>"/>
							</div>
						</div>
     ...
     <div class="row">
						...
						<!--  <label for="cardholder">Cardholder's Name</label>-->
						  <input type="text" required id="cardholder" name='card_holder' placeholder='Cardholder name' class="warning" value="<?php echo isset($_POST['name']) ? $_POST['name'] : ''?>">
		  </div>
		  </div>
...
">+</a>
			...
			<div class="row">
              ...
              <input type="text" required id="date" name='date' placeholder="MM / YY" class="warning" value="<?php if(isset($credit_data[0]->exp_month)):echo responsive_bartik_get_descrypt($credit_data[0]->exp_month).'/'.responsive_bartik_get_descrypt($credit_data[0]->exp_year);endif;?>">
			  </div>
			  </div>
			  <div class="pull-left col-xs-12 col-sm-12 col-md-3 col-lg-3" >
			  			<div class="form-group">
            ...
            <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6" ><div class="form-group">
				     <input type="text" required placeholder='Billing address' id="billing_address" name='billing_address' class="warning" value="<?php echo isset($_POST['address']) ? $_POST['address'] : ''?>"></div>
          </div>
          </div>
		 ...
		 <div class="row">
		  ...
		  <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding:0">
							<div class="form-group">
		    <input type="tel" size="3" id="code" value='1' name="phone" style='width:22%'>-(<input type="tel" size="3" name='phone1' id='phone1' style='width:22%'>) <input type="tel" name='phone2' size="3" id='phone2' style='width:22%'> - <input id='phone3' type="tel" name='phone3' size="4" style='width:24%'>
...
<div class="row">
              ...
              <input type="text"  id="city" name="city" placeholder="City" class="warning" value="<?php echo isset($_POST['city']) ? $_POST['city'] : ''?>">
            </div>
            </div>
        ...
        <div class="pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6" >
              ...
              <input type="text" id="state" style='width:50%' name="state" placeholder="State" class="warning" value="<?php echo isset($_POST['state']) ? $_POST['state'] : ''?>">
			  
              <input type="text" id="zip_code" style='width:48%' name="zip_code" placeholder="Zip code" class="warning">
            </div>
            </div>
		 ...
		 <div class="panel-footer" style="background:none">
		    <div class='row'> <input id='terms' type='checkbox' required='required'> I agree to the terms and conditions for using Pronoor Pay</div>
      <button class="btn next-btn" type="submit" value='1' id='pronoor_pay_submit' name='pronoor_pay_submit' style='margin-top: 99px;'>Submit</button>
    </div>
    </div>
	</form>
...
<input type='hidden' id='luhn' />
  <script src="https://www.pronoor.com/mail/js/jquery.min.js"></script>
        ...
        <ul class="nav footer_menu">
          <!--<li class="navbar-text"><a href="index.php">Directory Home</a></li>
            <li class="navbar-text"><a href="index.php?page=6&type=15">Secure Mail</a></li>-->
                        <li class="navbar-text"><a href="https://www.pronoor.com/index.php?page=6&amp;type=2">Contact Us</a></li>
			            <li class="navbar-text"><a href="https://www.pronoor.com/index.php?page=6&amp;type=22">Terms &amp; Conditions</a></li>
			            <li class="navbar-text"><a href="https://www.pronoor.com/index.php?page=6&amp;type=23">Privacy Policy</a></li>
			            <li class="navbar-text"><a href='javascript:void(0);' class="" data-toggle="modal" data-target="#myModal">RETURN AND REFUND POLICY</a></li>
			            <li class="navbar-text"><a href="https://www.pronoor.com/index.php?page=6&amp;type=32">About PWS</a></li>
			  
        </ul>
    </div>

    <div class="center footer_down">
        <p style="color:white">© 2014-18 ProNoor Directory, Email &amp; Shopping Cart. All Rights Reserved. ProNoor and MedNoor are Registered Trade Marks </p>
    </div>
</nav>
</div>
...
<script src="https://www.pronoor.com/mail/js/jquery.validate.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <script src="https://www.pronoor.com/mail/bower_components/bootstrap/dist/js/bootstrap.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="https://www.pronoor.com/mail/bower_components/metisMenu/dist/metisMenu.min.js"></script>

		  <script src="//cdn.datatables.net/1.10.5/js/jquery.dataTables.min.js"></script>
    <script src="https://www.pronoor.com/mail/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
    ...
    <!--<script src="https://www.pronoor.com/mail/bower_components/raphael/raphael-min.js"></script>
    <script src="https://www.pronoor.com/mail/bower_components/morrisjs/morris.min.js"></script>
    <script src="https://www.pronoor.com/mail/js/morris-data.js"></script>-->

    <!-- Custom Theme JavaScript -->
    <script src="https://www.pronoor.com/mail/dist/js/sb-admin-2.js"></script>
...
$( document ).ready(function() {
$("#pronoor_pay_submit").click(function(){
